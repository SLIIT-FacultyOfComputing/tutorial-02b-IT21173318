...
#include <iostream>
using namespace std;//allows program to output data to the screen

int main() //main function begins
{
  float cm,inches;
  cout << "Enter a length in cm :" ;// get input
  cin >> cm;

  inches = cm / 2.54;
  cout << "Length in inchhes is " << inches ;//display inches value
